...
public class LogicBlockModule implements IModule {
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_ANALOG = TILES.register("analog", () -> TileEntityType.Builder.of(AnalogTileEntity::new, ANALOG.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_COUNTER = TILES.register("counter", () -> TileEntityType.Builder.of(CounterTileEntity::new, COUNTER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<DigitTileEntity>> TYPE_DIGIT = TILES.register("digit", () -> TileEntityType.Builder.of(DigitTileEntity::new, DIGIT.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_INVCHECKER = TILES.register("invchecker", () -> TileEntityType.Builder.of(InvCheckerTileEntity::new, INVCHECKER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<SensorTileEntity>> TYPE_SENSOR = TILES.register("sensor", () -> TileEntityType.Builder.of(SensorTileEntity::new, SENSOR.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_SEQUENCER = TILES.register("sequencer", () -> TileEntityType.Builder.of(SequencerTileEntity::new, SEQUENCER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_LOGIC = TILES.register("logic", () -> TileEntityType.Builder.of(ThreeLogicTileEntity::new, LOGIC.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_TIMER = TILES.register("timer", () -> TileEntityType.Builder.of(TimerTileEntity::new, TIMER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_WIRE = TILES.register("wire", () -> TileEntityType.Builder.of(WireTileEntity::new, WIRE.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_REDSTONE_RECEIVER = TILES.register("redstone_receiver", () -> TileEntityType.Builder.of(RedstoneReceiverTileEntity::new, REDSTONE_RECEIVER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_REDSTONE_TRANSMITTER = TILES.register("redstone_transmitter", () -> TileEntityType.Builder.of(RedstoneTransmitterTileEntity::new, REDSTONE_TRANSMITTER.get()).build(null));
