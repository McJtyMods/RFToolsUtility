...
public class SyringeRecipeBuilder implements IRecipeBuilder<SyringeRecipeBuilder> {
    ...
    public SyringeRecipeBuilder(IItemProvider resultIn, int countIn, ResourceLocation mobId, int syringeIndex) {
    ...
    public static SyringeRecipeBuilder shaped(IItemProvider resultIn, ResourceLocation mobId, int syringeIndex) {
        return shaped(resultIn, 1, mobId, syringeIndex);
    }

    public static SyringeRecipeBuilder shaped(IItemProvider resultIn, int countIn, ResourceLocation mobId, int syringeIndex) {
        return new SyringeRecipeBuilder(resultIn, countIn, mobId, syringeIndex);
    }


    @Override
    public SyringeRecipeBuilder define(Character symbol, ITag<Item> tagIn) {
        return this.define(symbol, Ingredient.of(tagIn));
    }

    @Override
    public SyringeRecipeBuilder define(Character symbol, IItemProvider itemIn) {
    ...
    public SyringeRecipeBuilder unlockedBy(String name, ICriterionInstance criterionIn) {
