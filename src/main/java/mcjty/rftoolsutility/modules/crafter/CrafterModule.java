...
public class CrafterModule implements IModule {
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CRAFTER1 = TILES.register("crafter1", () -> TileEntityType.Builder.of(CrafterBlockTileEntity1::new, CRAFTER1.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CRAFTER2 = TILES.register("crafter2", () -> TileEntityType.Builder.of(CrafterBlockTileEntity2::new, CRAFTER2.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> TYPE_CRAFTER3 = TILES.register("crafter3", () -> TileEntityType.Builder.of(CrafterBlockTileEntity3::new, CRAFTER3.get()).build(null));
