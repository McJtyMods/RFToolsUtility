...
public class TeleporterModule implements IModule {
    ...
    public static final RegistryObject<Item> MATTER_TRANSMITTER_ITEM = ITEMS.register("matter_transmitter", tab(() -> new BlockItem(MATTER_TRANSMITTER.get(), createStandardProperties())));
    ...
    public static final RegistryObject<Item> MATTER_RECEIVER_ITEM = ITEMS.register("matter_receiver", tab(() -> new BlockItem(MATTER_RECEIVER.get(), createStandardProperties())));
    ...
    public static final RegistryObject<Item> DIALING_DEVICE_ITEM = ITEMS.register("dialing_device", tab(() -> new BlockItem(DIALING_DEVICE.get(), createStandardProperties())));
    ...
    public static final RegistryObject<Item> DESTINATION_ANALYZER_ITEM = ITEMS.register("destination_analyzer", tab(() -> new BlockItem(DESTINATION_ANALYZER.get(), createStandardProperties())));
    ...
    public static final RegistryObject<Item> MATTER_BOOSTER_ITEM = ITEMS.register("matter_booster", tab(() -> new BlockItem(MATTER_BOOSTER.get(), createStandardProperties())));
    ...
    public static final RegistryObject<TeleportProbeItem> TELEPORT_PROBE = ITEMS.register("teleport_probe", tab(TeleportProbeItem::new));
    public static final RegistryObject<ChargedPorterItem> CHARGED_PORTER = ITEMS.register("charged_porter", tab(ChargedPorterItem::new));
    public static final RegistryObject<AdvancedChargedPorterItem> ADVANCED_CHARGED_PORTER = ITEMS.register("advanced_charged_porter", tab(AdvancedChargedPorterItem::new));
