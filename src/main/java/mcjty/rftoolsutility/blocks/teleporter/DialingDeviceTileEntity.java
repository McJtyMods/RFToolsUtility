...
import static mcjty.rftoolsutility.blocks.teleporter.TeleporterSetup.CONTAINER_DIALING_DEVICE;
import static mcjty.rftoolsutility.blocks.teleporter.TeleporterSetup.TYPE_DIALING_DEVICE;
...
public class DialingDeviceTileEntity extends GenericTileEntity {
    ...
    // Server side only
    private int dial(UUID player, BlockPos transmitter, int transDim, BlockPos coordinate, int dimension, boolean once) {
