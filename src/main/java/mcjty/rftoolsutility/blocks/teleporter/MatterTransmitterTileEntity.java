...
import static mcjty.rftoolsutility.blocks.teleporter.TeleporterSetup.CONTAINER_MATTER_TRANSMITTER;
import static mcjty.rftoolsutility.blocks.teleporter.TeleporterSetup.TYPE_MATTER_TRANSMITTER;
...
public class MatterTransmitterTileEntity extends GenericTileEntity implements MachineInformation, ITickableTileEntity {
    ...
    public boolean checkAccess(UUID player) {
        ...
        ServerPlayerEntity entity = ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayerByUUID(player);
        if (entity == null) {
            return false;
        }
